...
class RolePermissionsModel extends BaseModel
{
  ...
  public function getDetails($conditions = []){
    ...
    $this->select('role_permissions.*, roles.role, permissions.permission, permissions.icon, permissions.slug, permission_types.type, permission_types.slug as type_slug, modules.id as module_id, permission_types.id as type_id');
