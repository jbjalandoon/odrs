            ...
            <div class="card-body">
              ...
              <form action="verify" method="post">
                  <div class="form-group">
                    <label for="username" class="sr-only"><i class="fas fa-user"></i>Student Number / Email</label>
                    <input type="username" name="username" id="username" class="form-control" placeholder="Student Number / Email" required>
